...
console.log('🏠 HomeSwift.ai - Database Setup');
console.log('==================================\n');
...
if (!supabaseUrl || !supabaseKey) {
  ...
  console.error('   Please run: node setup-supabase.js');
  console.error('   Then update your .env file with Supabase credentials');
  process.exit(1);
}
...
// Note: This script provides the SQL schema but doesn't execute it
...
console.log('3. Copy and paste the schema from the generated file');
console.log('4. Run the SQL to create tables and sample data');
console.log('');

// Save schema to file
const schemaPath = path.join(__dirname, 'database-schema.sql');
fs.writeFileSync(schemaPath, schema + sampleData);
console.log('✅ Schema saved to: database-schema.sql');
console.log('');

console.log('🚀 Your HomeSwift.ai database is ready!');
